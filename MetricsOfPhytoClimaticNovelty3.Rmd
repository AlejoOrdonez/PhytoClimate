...
# Rotate so it is not 0-360 but -180 to 180
  Ice <- rotate(Ice)
# Reproject to the same projection as the Raster template
  Ice <- raster::projectRaster(Ice,
                 cr.ea,
                 method = "ngb")
# Re sample so it alings with the Raster template
  Ice <- raster::resample(Ice,
                 raster::raster("./Data/raster_template.tif"),
                 method = "ngb")
# Save teh raster  
  raster::writeRaster(Ice,"./Data/IceCover21kaBP.tif",format="GTiff", overwrite=TRUE)
}
